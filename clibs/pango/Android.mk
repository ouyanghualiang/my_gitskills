...
LOCAL_C_INCLUDES = $(MAKEFILE_PATH) $(MAKEFILE_PATH)/include \
                   ...
                   $(MAKEFILE_PATH)/../cairo/cairo-extra $(MAKEFILE_PATH)/../harfbuzz/distsrc/src
LOCAL_SHARED_LIBRARIES := glib  gobject gmodule cairo fontconfig freetype #harfbuzz
LOCAL_STATIC_LIBRARIES := harfbuzz 

include $(BUILD_SHARED_LIBRARY)
$(call import-module,../../../home/ouyang/lib-native-activity/jni/harfbuzz)
